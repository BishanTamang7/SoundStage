    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#312E81]">
      ...
      <main className="ml-60 px-12 pt-2 pb-8 max-[1024px]:px-6 max-[768px]:ml-0">
        <header className="mb-8">
          <h1 className="text-2xl font-black text-[#312E81]">Scan QR</h1>
          <p className="mt-1 text-sm font-semibold text-[#6B7280]">Scan attendee ticket QR codes for entry validation.</p>
        </header>
      </main>
    </div>
  )
