    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#312E81]">
      ...
      <main className="ml-60 px-12 py-8 max-[1024px]:px-6 max-[768px]:ml-0 max-[768px]:px-4">
        <header className="mb-6 rounded-2xl border border-[#E5E7EB] bg-white p-6">
          <h1 className="text-2xl font-black text-[#312E81]">Profile</h1>
          <p className="mt-1 text-sm font-semibold text-[#6B7280]">
            Manage your organizer identity, login details, and account access.
          </p>
        </header>

        <section className="mb-6 flex flex-col gap-6 rounded-2xl border border-[#E5E7EB] bg-white p-8 lg:flex-row lg:items-center">
          <div className="flex flex-col items-center gap-4 lg:w-64">
            {profilePhoto ? (
              <img
                src={profilePhoto}
                alt={`${profileName} profile`}
                className="h-28 w-28 rounded-full object-cover shadow-[0_10px_30px_rgba(49,46,129,0.14)]"
              />
            ) : (
              <div className="flex h-28 w-28 items-center justify-center rounded-full bg-linear-to-br from-[#7C3AED] to-[#4F46E5] text-4xl font-black text-white shadow-[0_10px_30px_rgba(49,46,129,0.14)]">
                {initials}
              </div>
            )}
            <button
              className="rounded-lg border border-[#7C3AED] px-4 py-2 text-sm font-bold text-[#7C3AED] transition hover:bg-[#F5F3FF] disabled:cursor-not-allowed disabled:opacity-60"
              type="button"
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-black text-[#312E81]">{profileName}</h2>
            ...
            {photoMessage ? <p className="mt-3 text-sm font-semibold text-[#059669]">{photoMessage}</p> : null}
            {photoError ? <p className="mt-3 text-sm font-semibold text-[#B91C1C]">{photoError}</p> : null}
          </div>
        </section>

        <section className="mb-6 rounded-2xl border border-[#E5E7EB] bg-white p-6">
          <div className="border-b border-[#E5E7EB] pb-4">
            <h2 className="text-lg font-black text-[#312E81]">Account Details</h2>
            <p className="text-sm text-[#6B7280]">Update the details attached to your organizer account.</p>
          </div>
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                disabled
                readOnly
                className="rounded-lg border border-[#E5E7EB] bg-[#F9FAFB] px-4 py-3 text-sm text-[#312E81]"
              />
            </div>
        ...
        <section className="mb-6 rounded-2xl border border-[#E5E7EB] bg-white p-6">
          <div className="border-b border-[#E5E7EB] pb-4">
            ...
            <p className="text-sm text-[#6B7280]">Change your password to protect organizer dashboard access.</p>
          </div>
        ...
        <section className="rounded-2xl border border-[#FECACA] bg-white p-6">
          <div className="border-b border-[#FEE2E2] pb-4">
            <h2 className="text-lg font-black text-[#991B1B]">Danger Zone</h2>
            <p className="text-sm text-[#B91C1C]">Delete your organizer account permanently.</p>
          </div>

          {deleteError ? <p className="mt-4 text-sm font-semibold text-[#B91C1C]">{deleteError}</p> : null}

          <button
            className="mt-5 rounded-lg border border-[#FCA5A5] bg-[#FEF2F2] px-5 py-2.5 text-sm font-bold text-[#B91C1C] transition hover:bg-[#FEE2E2] disabled:cursor-not-allowed disabled:opacity-60"
            type="button"
